...
namespace pfswitch13{
    ...
    struct PathHdr{
        ...
        public:
            ...
            ParhHdr(unsigned pid,unsigned out_port):pid(pid),out_port(out_port){}
    };
    ...
    class SwitchS4:public SwitchS1{
        ...
        public:
            ...
            SwitchS4(const vigil::datapathid dpid,const std::string &name,
                     ...
                     PathHdr **_ps):SwitchS1(dpid,name,data,src_ip,dst_ip){
                ps=*_ps;
                *_ps=0;
            }

            SwitchS4(const unsgined dpid,const std::string &name,
                     ipv4_addr src_ip,ipv4_addr dst_ip,
                     const SwitchData &data,
                     PathHdr **_ps):Switch13(dpid,name,data,src_ip,dst_ip){
                ps=*_ps;
                *_ps=0;
            }
